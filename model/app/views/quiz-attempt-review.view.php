                    ...
                    <?php foreach ($student_quiz_details["quiz_questions"] as $studentquestion): ?>
                        <div class="questions-page-question-wrapper">
                            ...
                            <div class="questions-page-question-container">
                                ...
                                <?php endif; ?>
                                <?php if($studentquestion->question_type != "essayQuestion"): ?>
                                    <p class="correct-answer-message">The correct answer is: <span><?= displayCorrectAnswer($studentquestion->choices) ?></span></p>
                                <?php else: ?>
                                    <p class="correct-answer-message">You Got <?= getQuestionGrade($studentquestion->student_quiz_question) ?> Grade In This Question</p>    
                                <?php endif; ?>

                            </div>
                        </div>
                    <?php endforeach; ?>
                    <a href="<?= ROOT ?>Quiz/quizDisplay/<?= $course_id ?>/<?= $quiz_id ?>" class="questions-page-move-next">
                        Back To Quiz
                    </a>
                </div>
            </form>
