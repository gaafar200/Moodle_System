                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            <input name="coursename" type="text" value="<?= displayCourseName($CourseData) ?>"
                                                                   class="form-control" placeholder="Course Name">
                                                            <?php if (isset($errors) && isset($errors["coursename"])): ?>
                                                                <em for="coursename" class="invalid"><?= ucfirst($errors["coursename"]) ?></em>
                                                            <?php endif; ?>           
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                                    <textarea name="description"
                                                                              placeholder="Description" ><?= displayCourseDescription($CourseData) ?></textarea>
                                                            <?php if (isset($errors) && isset($errors["description"])): ?>
                                                                <em for="description" class="invalid"><?= ucfirst($errors["description"]) ?></em>
                                                            <?php endif; ?>                  
                                                        </div>
                                                        <div class="form-group">
                                                            <input name="professorusername" type="text" value="<?= displayCourseLecturerUsername($CourseData) ?>"
                                                                   class="form-control" placeholder="Professor username">
                                                            <?php if (isset($errors) && isset($errors["username"])): ?>
                                                                <em for="professorusername" class="invalid"><?= ucfirst($errors["username"]) ?></em>
                                                            <?php endif; ?>       
                                                        </div>
                                                    </div>
                                                </div>
