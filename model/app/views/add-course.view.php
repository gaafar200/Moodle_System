                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="coursename" type="text" value="<?= displayOldCourseName($old_data) ?>"
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <textarea name="description"
                                                                        placeholder="Description"><?= displayOldCourseDescription($old_data) ?></textarea>
                                                                        <?php if (isset($errors) && isset($errors["description"])): ?>
                                                                            <em for="description" class="invalid"><?= ucfirst($errors["description"]) ?></em>
                                                                        <?php endif; ?>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="professorusername" type="text" value="<?= displayOldProfessorUsername($old_data) ?>"
