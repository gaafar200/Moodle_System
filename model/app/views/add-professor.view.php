                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <select class="form-control" name="gender">
                                                                        ...
                                                                        <option value="male" <?= SelectUserOldGender($old_data, "male") ?> >Male</option>
                                                                        <option value="female" <?= SelectUserOldGender($old_data, "female") ?> >Female</option>
                                                                    </select>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php if(isset($errors) && isset($errors["passwords"])): ?>
                                                                        <em for="confirmpassword" class="invalid"><?= ucfirst($errors["passwords"]) ?></em>
                                                                    <?php endif; ?>
                                                                </div>
                                                                <div class="form-group">
                                                                <textarea name="description" class="form-control" placeholder="Enter The Lecturer description"><?= displayOldDescription($old_data) ?></textarea>
