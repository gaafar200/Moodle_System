                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="latest-blog-single blog-single-full-view">
                                <div class="top-btn">
                                    ...
                                    <a href="<?= ROOT ?>Assignment/set/<?= $course_id ?>"><button type="button" class="btn btn-custon-rounded-four btn-success btnWidth">Set Assignment</button></a>
                                </div>
                                        ...
                                        <?php foreach ($assignment_data as $assignment) : ?>
                                            <form method="POST">
                                                <div class="table-tbody mt-2">
                                                    ...
                                                    <div class="td"><?= $assignment->name ?></div>
                                                    <div class="td-flex"><?= $assignment->start_date ?></div>
                                                    <div class="td-flex"><?= $assignment->deadline ?></div>
                                                    <div class="td-flex"><?= $assignment->mark_value ?></div>
                                                    <div class="td-last quiz-list-btns  ">
                                                        <a href="<?= ROOT ?>Assignment/edit/<?= $assignment->id ?>/<?= $course_id ?>"><button type="button" class="btn btn-success">Edit</button></a>
                                                        <a href="<?= ROOT ?>StudentAssignments/<?= $assignment->id ?>/<?= $course_id ?>"><button type="button" class="btn btn-success">Marks</button></a>
                                                        <form method="POST">
