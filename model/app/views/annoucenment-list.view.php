                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="latest-blog-single blog-single-full-view">
                                <div class="top-btn">
                                    ...
                                    <a href="<?= ROOT ?>Announcement/set/<?= $course_id ?>"><button type="button" class="btn btn-custon-rounded-four btn-success btnWidth">Set Announcement</button></a>
                                </div>
                                <div class="table-flex">

                                    <div class="tabel-thead">
                                        <div class="td-id"> ID </div>
                                        <div class="td"> Announcement Name </div>
                                        <div class="td-flex">Announcement Date</div>
                                        ...
                                        <?php foreach ($announcement_data as $announcement) : ?>
                                            <form method="POST">
                                                <div class="table-tbody mt-2">
                                                    ...
                                                    <div class="td"><?= $announcement->title ?></div>
                                                    <div class="td-flex"><?= $announcement->date ?></div>
                                                    <div class="td-last quiz-list-btns  ">
                                                        <a href="<?= ROOT ?>Announcement/edit/<?= $announcement->id ?>/<?= $course_id ?>"><button type="button" class="btn btn-success">Edit</button></a>
                                                        <form method="POST">
